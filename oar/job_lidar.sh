...
#OAR -O oar/runs/hisup_lidar_pp_o3d.out
#OAR -E oar/runs/hisup_lidar_pp_o3d.out 
...
torchrun --nproc_per_node=2 scripts/train.py log_to_wandb=true host=g5k run_type=release multi_gpu=true experiment_name=v3_lidar_pp_o3d_bs2x16 checkpoint=null model.batch_size=16 encoder=pointpillars model=hisup
