...
#OAR -O oar/runs/ffl_image_015.out
#OAR -E oar/runs/ffl_image_015.out
#OAR -n ffl_image_015
...
torchrun --nproc_per_node=2 scripts/train.py log_to_wandb=true host=g5k run_type=release host.multi_gpu=true checkpoint=null experiment=ffl_image experiment.name=ffl_image_015 country=Switzerland dataset.size=224015
