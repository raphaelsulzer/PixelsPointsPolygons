...
#OAR -O oar/runs/ffl_lidar_mnv8_c.out
#OAR -E oar/runs/ffl_lidar_mnv8_c.out 
...
torchrun --nproc_per_node=2 scripts/train.py log_to_wandb=true host=g5k run_type=release host.multi_gpu=true checkpoint=null experiment=lidar_density_ablation8 checkpoint=latest