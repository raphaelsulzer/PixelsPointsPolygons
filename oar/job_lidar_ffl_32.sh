...
#OAR -O oar/runs/ffl_lidar_mnv32.out
#OAR -E oar/runs/ffl_lidar_mnv32.out 
...
torchrun --nproc_per_node=2 scripts/train.py log_to_wandb=true host=g5k run_type=release host.multi_gpu=true checkpoint=null experiment=lidar_density_ablation32
