...
#OAR -O oar/runs/p2p_all.out
#OAR -E oar/runs/p2p_all.out
#OAR -n p2p_all
...
torchrun --nproc_per_node=2 scripts/train.py log_to_wandb=true host=g5k run_type=release host.multi_gpu=true checkpoint=null experiment=p2p_fusion_building_ann experiment.name=building_fusion_bs2x16
