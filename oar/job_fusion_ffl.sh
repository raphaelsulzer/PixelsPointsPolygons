...
torchrun --nproc_per_node=2 scripts/train.py log_to_wandb=true host=g5k run_type=release host.multi_gpu=true experiment_name=fusion_vit_cnn_bs2x16_mnv64 checkpoint=null model.batch_size=16 encoder=early_fusion_vit_cnn model=ffl