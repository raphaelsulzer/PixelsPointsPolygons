...
torchrun --nproc_per_node=2 scripts/train.py log_to_wandb=false host=g5k run_type=debug multi_gpu=true experiment_name=debug checkpoint=null model.batch_size=4 use_lidar=False use_images=True