...
def predict_all():
    ...
    with initialize(config_path="../config", version_base="1.3"):
        ...
        for experiment, name in experiments:
            ...
            overrides = cli_overrides + \
                ...
                #  f"experiment.lidar_dropout=1.0",
                 f"experiment.name={name}", f"experiment.dataset.country=CH", f"evaluation=val", 
        ...
        cfg.evaluation.eval_file = f"{cfg.evaluation.eval_file}_droplidar50_ablation_{cfg.experiment.dataset.country}_{cfg.evaluation.split}.csv"
