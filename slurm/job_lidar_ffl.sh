...
#SBATCH --job-name=lidar_pp_vit_cnn_bs4x8  # Job name
#SBATCH --output=./slurm/runs/lidar_ffl_pp_vit_cnn_bs4x16.log       # Standard output and error log
#SBATCH --error=./slurm/runs/lidar_ffl_pp_vit_cnn_bs4x16.log         # Error log
...
torchrun --nproc_per_node=4 scripts/train.py log_to_wandb=true host=jz run_type=release multi_gpu=true checkpoint=null model.batch_size=16 experiment_name=v3_image_pp_vit_cnn_bs4x16 model=ffl encoder=pointpillars_vit_cnn