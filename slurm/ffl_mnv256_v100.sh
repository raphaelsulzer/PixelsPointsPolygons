...
torchrun --nproc_per_node=4 scripts/train.py log_to_wandb=true host=jz run_type=release host.multi_gpu=true checkpoint=null experiment=lidar_density_ablation256 country=Switzerland experiment.name=v5_lidar_bs4x16_mnv256