...
#SBATCH --job-name=pred_ffl_lidar_h100  # Job name
#SBATCH --output=./slurm/runs/pred_ffl_lidar_h100.log       # Standard output and error log
#SBATCH --error=./slurm/runs/pred_ffl_lidar_h100.log         # Error log
...
python scripts/predict.py host=jz run_type=release host.multi_gpu=false checkpoint=best_val_iou country=Switzerland eval.split=test experiment=lidar_density_ablation512 experiment.name=v5_lidar_bs2x16_mnv512