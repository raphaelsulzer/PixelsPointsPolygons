...
#SBATCH --output=./slurm/runs/ffl_fusion_bs4x16.log       # Standard output and error log
#SBATCH --error=./slurm/runs/ffl_fusion_bs4x16.log         # Error log
...
torchrun --nproc_per_node=4 scripts/train.py log_to_wandb=true host=jz run_type=release host.multi_gpu=true checkpoint=null experiment=ffl_fusion