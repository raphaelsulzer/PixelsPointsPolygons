...
#SBATCH --job-name=p2p_image_bs4x16  # Job name
#SBATCH --output=./slurm/runs/p2p_image_bs4x16.log       # Standard output and error log
#SBATCH --error=./slurm/runs/p2p_image_bs4x16.log         # Error log
...
torchrun --nproc_per_node=4 scripts/train.py run_type=release host=jz experiment=p2p_image experiment.name=image_bs4x16_jz experiment.group_name=v3_pix2poly