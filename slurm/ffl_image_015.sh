...
#SBATCH --job-name=ffl_image_015_bs4x16  # Job name
#SBATCH --output=./slurm/runs/ffl_image_015_bs4x16.log       # Standard output and error log
#SBATCH --error=./slurm/runs/ffl_image_015_bs4x16.log         # Error log
