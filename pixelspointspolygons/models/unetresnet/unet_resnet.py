...
class UNetResNetBackbone(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.dropout_2d = cfg.experiment.encoder.dropout_2d
        pretrained = 'DEFAULT' if cfg.experiment.encoder.pretrained else None
        num_filters = cfg.experiment.encoder.num_filters
        is_deconv = cfg.experiment.encoder.is_deconv
        
        if cfg.experiment.encoder.depth == 34:
            self.encoder = torchvision.models.resnet34(weights=pretrained)
            bottom_channel_nr = 512
        elif cfg.experiment.encoder.depth == 101:
            self.encoder = torchvision.models.resnet101(weights=pretrained)
            bottom_channel_nr = 2048
        elif cfg.experiment.encoder.depth == 152:
