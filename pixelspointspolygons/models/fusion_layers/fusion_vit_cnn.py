...
class FusionViTCNN(torch.nn.Module):
    ...
    def __init__(self, cfg, local_rank=0):
        ...
        self.fusion_layer = nn.Sequential(
            nn.Conv2d(self.cfg.experiment.encoder.patch_feature_dim*2, self.cfg.experiment.model.decoder.in_feature_dim, kernel_size=3, padding=1),
    ...
    def forward(self, x_image, x_lidar):
        ...
        x_image = x_image.permute(0, 2, 1).view(B, C, H, W)
